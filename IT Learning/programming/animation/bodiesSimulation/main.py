...
class Body:
    ...
    def updPos(self, bodies):
        ...
        self.x_vel += ((total_fx / self.mass) * self.TIMESTEP) + abs(0.001 / (total_fx / fx))
...
if __name__ == '__main__':
    ...
    b_m = 10 ** 22
    b1 = Body(-7 * Body.DIS, 0, 5, (0, 0, 0), b_m)
    b1.y_vel = math.sqrt((Body.G * b_m) / (2.3 * 10 ** 10))
    b2 = Body(-6 * Body.DIS, 0, 5, (0, 0, 0), b_m)
    b2.y_vel = -math.sqrt((Body.G * b_m) / (2.3 * 10 ** 10))
